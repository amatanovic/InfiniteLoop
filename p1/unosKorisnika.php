...
<h4>Unos novog korisnika</h4>
 <form method="POST" action="" enctype="multipart/form-data">
    <input class="odaberi-avatar" style="margin-top:1em;width:72%;margin-left: 16%;border: none;" type="file" name="avatar" id="avatar" accept="image/*" />
    ...
    <div class="input-group privatni-profil">
     ...
     <div class="input-group privatni-profil">
      <span class="input-group-addon profil">Korisničko ime</span>
      <input type="text" name="korisnicko_ime" class="form-control" aria-describedby="basic-addon1" />
    </div>
    <div class="input-group privatni-profil">
    ...
    <input type="submit" value="Unesi novog korisnika" name="registracija" class="btn btn-default" />
    </div>
    </div>
  </form>
</p>